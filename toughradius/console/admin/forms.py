...
def product_add_form():
    return pyforms.Form(
        ...
        pyforms.Textbox("input_max_limit",  rules.is_number,description=u"最大上行速率(kb)", **input_style),
        pyforms.Textbox("output_max_limit",  rules.is_number,description=u"最大下行速率(kb)",**input_style),
