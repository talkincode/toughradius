...
@permit.route(r"/admin/node", u"区域节点管理",settings.MenuRes, order=1.0000, is_menu=True)
...
@permit.route(r"/admin/node/add", u"新增区域", settings.MenuRes, order=1.0001)
...
@permit.route(r"/admin/node/update", u"修改区域", settings.MenuRes, order=1.0002)
...
@permit.route(r"/admin/node/delete", u"删除区域", settings.MenuRes, order=1.0003)
