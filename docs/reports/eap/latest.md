# EAP Acceptance Test Report - 2026-07-27
...
| Field | Value |
| --- | --- |
| Started | 2026-07-27T12:37:39Z |
| Finished | 2026-07-27T12:37:40Z |
| Commit | 2bf67750ac35 |
| Ref | main |
| Workflow | [workflow run](https://github.com/talkincode/toughradius/actions/runs/30266632598) |
| Runner OS | Linux |
...
| EAP-TLS untrusted client certificate | EAP-TLS | Access-Reject | passed | 36 ms | external supplicant was rejected as expected |
...
| EAP-TTLS/MSCHAPv2 valid credentials | EAP-TTLS/MSCHAPv2 | Access-Accept | passed | 139 ms | external supplicant received the expected Access-Accept |
...
| EAP-TLS untrusted client certificate | EAP-TLS | Access-Reject | 通过 | 36 ms | external supplicant was rejected as expected |
...
| EAP-TTLS/MSCHAPv2 valid credentials | EAP-TTLS/MSCHAPv2 | Access-Accept | 通过 | 139 ms | external supplicant received the expected Access-Accept |
