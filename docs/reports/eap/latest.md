# EAP Acceptance Test Report - 2026-08-03
...
| Field | Value |
| --- | --- |
| Started | 2026-08-03T12:37:21Z |
| Finished | 2026-08-03T12:37:21Z |
| Commit | 2bf67750ac35 |
| Ref | main |
| Workflow | [workflow run](https://github.com/talkincode/toughradius/actions/runs/30814276748) |
| Runner OS | Linux |
...
| --- | --- | --- | --- | ---: | --- |
| EAP-TLS valid client certificate | EAP-TLS | Access-Accept | passed | 191 ms | external supplicant received the expected Access-Accept |
...
| EAP-TTLS/PAP valid credentials | EAP-TTLS/PAP | Access-Accept | passed | 141 ms | external supplicant received the expected Access-Accept |
| EAP-TTLS/MSCHAPv2 valid credentials | EAP-TTLS/MSCHAPv2 | Access-Accept | passed | 142 ms | external supplicant received the expected Access-Accept |
...
| 场景 | 方法 | 预期 | 状态 | 耗时 | 说明 |
| --- | --- | --- | --- | ---: | --- |
| EAP-TLS valid client certificate | EAP-TLS | Access-Accept | 通过 | 191 ms | external supplicant received the expected Access-Accept |
...
| EAP-TTLS/PAP valid credentials | EAP-TTLS/PAP | Access-Accept | 通过 | 141 ms | external supplicant received the expected Access-Accept |
| EAP-TTLS/MSCHAPv2 valid credentials | EAP-TTLS/MSCHAPv2 | Access-Accept | 通过 | 142 ms | external supplicant received the expected Access-Accept |
