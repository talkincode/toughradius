# -*- coding: utf-8 -*-
#
# ToughRADIUS documentation build configuration file, created by
...
project = u'ToughRADIUS'
copyright = u'2015, jamiesun.net@gmail.com'
...
htmlhelp_basename = 'ToughRADIUSdoc'
...
man_pages = [
    ('index', 'toughradius', u'ToughRADIUS Documentation',
     [u'jamiesun.net@gmail.com'], 1)
]
...
texinfo_documents = [
  ('index', 'ToughRADIUS', u'ToughRADIUS Documentation',
   u'jamiesun.net@gmail.com', 'ToughRADIUS', 'ToughRADIUS is a Radius Server',
   'Miscellaneous'),
]
...
epub_title = u'ToughRADIUS'
epub_author = u'jamiesun.net@gmail.com'
epub_publisher = u'jamiesun.net@gmail.com'
epub_copyright = u'2015, jamiesun.net@gmail.com'
