...
| 场景 | 方法 | 预期 | 状态 | 耗时 | 说明 |
| --- | --- | --- | --- | ---: | --- |
| EAP-TLS valid client certificate | EAP-TLS | Access-Accept | 通过 | 190 ms | external supplicant received the expected Access-Accept |
...
| EAP-TTLS/PAP valid credentials | EAP-TTLS/PAP | Access-Accept | 通过 | 136 ms | external supplicant received the expected Access-Accept |
