...
| --- | --- | --- | --- | ---: | --- |
| EAP-TLS valid client certificate | EAP-TLS | Access-Accept | passed | 142 ms | external supplicant received the expected Access-Accept |
...
| EAP-TTLS/PAP valid credentials | EAP-TTLS/PAP | Access-Accept | passed | 120 ms | external supplicant received the expected Access-Accept |
