...
public class RadiusStat {
    ...
    private final ConcurrentLinkedDeque<long[]> reqBytesStat = new ConcurrentLinkedDeque<long[]>();
    private final ConcurrentLinkedDeque<long[]> respBytesStat = new ConcurrentLinkedDeque<long[]>();
    private final ConcurrentLinkedDeque<long[]> authReqStat = new ConcurrentLinkedDeque<long[]>();
    private final ConcurrentLinkedDeque<long[]> authRespStat = new ConcurrentLinkedDeque<long[]>();
    private final ConcurrentLinkedDeque<long[]> acctReqStat = new ConcurrentLinkedDeque<long[]>();
    private final ConcurrentLinkedDeque<long[]> acctRespStat = new ConcurrentLinkedDeque<long[]>();

    private final AtomicInteger online = new AtomicInteger(0);
    private final AtomicInteger authReqOld = new AtomicInteger(0);
    private final AtomicInteger authRespOld = new AtomicInteger(0);
    private final AtomicInteger authReq = new AtomicInteger(0);
    private final AtomicInteger authAccept = new AtomicInteger(0);
    private final AtomicInteger authReject = new AtomicInteger(0);
    private final AtomicInteger authRejectdelay = new AtomicInteger(0);
    private final AtomicInteger authDrop = new AtomicInteger(0);
    private final AtomicInteger acctStart = new AtomicInteger(0);
    private final AtomicInteger acctStop = new AtomicInteger(0);
    private final AtomicInteger acctUpdate = new AtomicInteger(0);
    private final AtomicInteger acctOn = new AtomicInteger(0);
    private final AtomicInteger acctOff = new AtomicInteger(0);
    private final AtomicInteger acctReqOld = new AtomicInteger(0);
    private final AtomicInteger acctRespOld = new AtomicInteger(0);
    private final AtomicInteger acctReq = new AtomicInteger(0);
    private final AtomicInteger acctResp = new AtomicInteger(0);
    private final AtomicInteger acctRetry = new AtomicInteger(0);
    private final AtomicInteger acctDrop = new AtomicInteger(0);
    private final AtomicInteger reqBytes = new AtomicInteger(0);
    private final AtomicInteger respBytes = new AtomicInteger(0);
    private final AtomicInteger reqBytesOld = new AtomicInteger(0);
    private final AtomicInteger respBytesOld = new AtomicInteger(0);
