  ...
  resources: {
    'radius/users': {
      ...
      helpers: {
        ...
        profile_id: 'Select RADIUS billing profile for the user',
        expire_time: 'Service expiration time, leave blank for never expire',
        ip_addr: 'Static IPv4 address, e.g. 192.168.1.100',
        ipv6_addr: 'Static IPv6 address, e.g. 2001:db8::1',
        remark: 'Optional remark, max 1000 characters',
      },
      empty_text: {
