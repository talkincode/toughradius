...
const customChineseMessages: TranslationMessages = {
  ...
  dashboard: {
    ...
    ipv6_coverage: 'IPv6 覆盖情况',
    ipv6_coverage_desc: '当前在线会话的 IPv6 使用分布，以及用户库的静态 IPv6 配置情况',
    ipv6_adoption: 'IPv6 占比',
    ipv6_online: 'IPv6 在线会话',
    ipv6_address: 'IPv6 地址',
    ipv6_framed_prefix: 'Framed 前缀',
    ipv6_delegated_prefix: '委派前缀',
    ipv6_users_static_address: '已配置静态 IPv6 地址用户',
    ipv6_users_delegated_prefix: '已配置委派前缀用户',
    week_days: {
      monday: '周一',
      tuesday: '周二',
      wednesday: '周三',
  ...
  resources: {
    ...
    'radius/online': {
      ...
      dialog: {
        ...
        coa_title: '修改在线授权',
        coa_content: '向 NAS 发送 RFC 5176 CoA 请求以更新用户 "%{username}" 的会话授权，仅填写需要变更的字段。',
        coa_session_timeout: '会话超时（秒）',
        coa_filter_id: '过滤器 ID (Filter-Id)',
        coa_no_changes: '请至少填写一个要变更的字段',
        coa_timeout_invalid: '会话超时必须是非负整数（秒）',
      ...
      notifications: {
        ...
        action_error: '%{action}请求失败：%{message}',
        unknown_cause: '未知原因',
      },
    },
    'radius/accounting': {
